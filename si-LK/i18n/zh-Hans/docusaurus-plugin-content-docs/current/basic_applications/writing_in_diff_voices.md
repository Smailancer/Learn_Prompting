...
[ChatGPT](https://chat.openai.com/chat) 等 AI 以可快速撰写论文和博客文章而闻名。但通常，他们创作的文章是过于宽泛且有些枯燥的。你需要做一些额外的事情来让这些内容更加生动和具体。 最快的方法之一是在提示中指定写作风格或指定某位著名的作者。 假设你想要一段关于友谊的重要性的段落。 像“给我写一段关于友谊的重要性”这样宽泛的提示将导致 ChatGPT 生成宽泛、平平无奇的内容。
...
现在开始生动美妙起来了。 也不一定是著名作家。您也可以使用知名人士，例如 Chris Rock。
...
简单地向它展示您之前编写的一些内容就足够了。这是一个示例，我们向 GPT-3 展示了一些 'Dr. Rodriguez' 曾写过的电子邮件，并要求它以相同的样式向新患者 Inuez 先生写一封新电子邮件。 <iframe
